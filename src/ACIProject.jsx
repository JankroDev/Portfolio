    ...
    <div className="sideSpace">
      ...
      <Card style={{paddingBottom:'5vh', marginTop: '5vh' }}>
        ...
        <Card.Text style={{padding:"20px"}}>
          The techs in their shop weren't "tech savy", so anytime a new label would need to be created
          manually by a designer. This would cause a loss of effeciency from the team as the designer would 
          have to drop their current tasks to take care of the new tag that needed formatted, inserted into the 
          existing database and then label orders created with info from the techs. This was a lot of leg work on
          ...
          to the designer. The designer also experienced a loss of time running back and forth and reseting, and reuploading
          any time there was a change in the format, or a new tag.
        </Card.Text>
        ...
        <Card.Text style={{padding:"20px"}}>
          ...
          templates online. They could upload the new tag image, then select where they want the text boxes, 
          select what order they want them in, and how many boxes they want to print.  
        </Card.Text>
